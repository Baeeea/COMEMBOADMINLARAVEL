<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
    <!-- Add verification success/error messages -->
    @if(session('success'))
    ...
    @if(session('error'))
      <div class="alert alert-danger alert-dismissible fade show position-fixed top-0 start-50 translate-middle-x mt-3" style="z-index: 1055;" role="alert">
        {{ session('error') }}
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      </div>
    @endif
